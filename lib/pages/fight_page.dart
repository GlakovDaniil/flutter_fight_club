...
class FightPageState extends State<FightPage> {
      ...
      body: SafeArea(
        child: Column(
          children: [
                    ...
                    child: SizedBox(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          style:
                          const TextStyle(color: FightClubColors.darkGreyText),
                        ),
                      ),
                    ),
                  ),
            ...
            ActionButton(
              text: yourLives == -1 || enemiesLives == -1
                  ? "Back"
                  : "Go",
  ...
  String _calculateCenterText(final bool youLoseLife, final bool enemyLoseLife) {
    if (enemiesLives == -1 && yourLives == -1) {
      return "Draw";
    } else if (yourLives == -1) {
      return "You lost";
    } else if (enemiesLives == -1) {
      return "You won";
    } else {
